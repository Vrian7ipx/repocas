...
{	
    ...
    <table border = "0">
        ...
        <td width="250" align="center">&nbsp;'.$city_casa.'</td>
        <tr>
        <td width="250" align="center"><b>'.$sucursal.'</b></td>
        </tr>
        <tr>
        <td width="250" align="center">'.$direccion.'</td>
        </tr>
        <tr>
        <td width="250" align="center">Telfs: '.$telefonos.'</td>
        </tr>
        <tr>
        <td width="250" align="center">&nbsp;'.$ciudad.'</td>
        </tr>
    </table>';
} 

$pdf->writeHTMLCell($w=0, $h=0, $x='15', $y='38', $datoEmpresa, $border=0, $ln=1, $fill=0, $reseth=true, $align='left', $autopadding=true);
//actividad económica
