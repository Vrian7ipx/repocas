...
@section('encabezado_descripcion') Gestión de Precios @stop
@section('nivel') <li><a href="{{URL::to('precios')}}"><i class="fa fa-cube"></i> Items</a></li>
         <li class="active"> Precios </li> @stop

@section('content')

<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title"><a href="{{ url('precios/create') }}" class="btn btn-success" role="button">Nuevo Precio &nbsp<span class="glyphicon glyphicon-plus-sign"></span></a></h3>
    <div class="box-tools pull-right">
      <!-- Buttons, labels, and many other things can be placed here! -->
      <!-- Here is a label for example -->
      <span class="label label-info">Precios</span>
    </div><!-- /.box-tools -->
  </div><!-- /.box-header -->
     ...
     <table id="datatable" class="table table-striped table-hover" cellspacing="0" cellpadding="0" width="100%" style="margin-left:24px;">
          ...
          @foreach($precios as $precio)
              <tr>
                  ...
                  <td>
                    <div class="dropdown">
			            <a class="btn btn-success btn-xs" data-task="view" href="{{ URL::to("precios/".$precio->id.'/edit') }}"  style="text-decoration:none;color:white;"><i class="glyphicon glyphicon-edit"></i></a>
